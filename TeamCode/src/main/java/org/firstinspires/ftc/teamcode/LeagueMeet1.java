...
//auto-intake
        ...
        /*if (gamepad2.b){
            colorRead = "none";
            while (Objects.equals(colorRead, "none")){
                Color.RGBToHSV(
                        color.red() * 8,
                        color.green() * 8,
                        color.blue() * 8,
            ...
            Spindex.setMode(DcMotor.RunMode.RUN_TO_POSITION);
            Spindex.setPower(1);
            telemetry.addData("IntakePosition","2");
            telemetry.update();
            try {
                Thread.sleep(1000);
            } catch (InterruptedException e) {
            ...
            Spindex.setMode(DcMotor.RunMode.RUN_TO_POSITION);
            Spindex.setPower(1);
            telemetry.addData("IntakePosition","3");
            telemetry.update();
            try {
                Thread.sleep(1000);
            } catch (InterruptedException e) {
            ...
            Spindex.setTargetPosition(-ticksCount);
            Spindex.setPower(1);
            telemetry.addData("IntakePosition","1");
            telemetry.update();
            try {
                Thread.sleep(2000);
            } catch (InterruptedException e) {
            ...
            Spindex.setTargetPosition(-588);
            Spindex.setMode(DcMotor.RunMode.RUN_TO_POSITION);
            Spindex.setPower(1);
            telemetry.addData("LaunchPosition","1");
            telemetry.update();
            try {
                Thread.sleep(1000);
            } catch (InterruptedException e) {
            ...
            Spindex.setTargetPosition(-1515);
            Spindex.setMode(DcMotor.RunMode.RUN_TO_POSITION);
            Spindex.setPower(1);
            telemetry.addData("LaunchPosition","2");
            telemetry.update();
            try {
                Thread.sleep(1000);
            } catch (InterruptedException e) {
            ...
            Spindex.setTargetPosition(-2513);
            Spindex.setMode(DcMotor.RunMode.RUN_TO_POSITION);
            Spindex.setPower(1);
            telemetry.addData("LaunchPosition","3");
            telemetry.update();
            try {
                Thread.sleep(1000);
            } catch (InterruptedException e) {
