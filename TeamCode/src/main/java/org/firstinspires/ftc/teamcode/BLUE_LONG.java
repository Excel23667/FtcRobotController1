...
@Disabled
@Autonomous(name = "BLUE LONG",group = "BLUE")
public class BLUE_LONG extends OpMode {
    ...
    private final Pose startPose = new Pose(144-83.21495327102805,11.757009345794401,Math.toRadians(180-68));
    private final Pose shootPose = new Pose(144-86.57943925233647,18.26168224299067,Math.toRadians(180-68));
    private final Pose preBallCollect1 = new Pose(144-86.57943925233647,35.475700934579436,Math.toRadians(180));
    private final Pose ballCollect1 = new Pose(144-131.37383177570098,38,Math.toRadians(180));
    private final Pose leavePose = new Pose(144-83.03738317757009,41.925233644859816,Math.toRadians(180));
    ...
    public void statePathUpdate(){
        switch (pathState){
            ...
            case SHOOTER_WARMUP_PRE:
                ...
                hood.setPosition(1);
                shooterRight.setVelocity(1680);
                shooterLeft.setVelocity(1680);
