...
public class RED_SHORT_9_BALL_GATE extends OpMode {
    ...
    private final Pose preGate = new Pose(113.94579439252337,69.3,Math.toRadians(0));
    private final Pose gate = new Pose(126,69.3,Math.toRadians(0));
    ...
    public void buildPaths(){
        ...
        driveGateToShoot = follower.pathBuilder()
                ...
                .setLinearHeadingInterpolation(gate.getHeading(), shootPose.getHeading(),0.7)
                .build();
